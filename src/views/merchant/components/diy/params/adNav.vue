    ...
    <el-form size="small" :model="curItem" label-width="100px">
          ...
          <template #item="{ element, index }">
            ...
            >
              ...
              <div class="right">
                ...
                <div class="url-box mb16 flex-1 d-s-c ww100">
                  <span class="key-name">副标题</span>
                  <el-input v-model="element.text" clearable></el-input>
                </div>
                <div class="url-box mb16 flex-1 d-s-c ww100">
                  <span class="key-name">副标题颜色</span>
                  <div class="flex-1 d-s-c" style="height: 36px">
                    <el-color-picker
                      size="default"
                      v-model="element.subTitlecolor"
                    ></el-color-picker>
                    <el-input
                      class="ml10"
                      v-model="element.subTitlecolor"
                    ...
                    <el-button
                      style="margin-left: 10px"
                      @click.stop="
                        onEditorResetColor(element, 'subTitlecolor', '#999999')
                      "
                      type="primary"
                      link
                    >
      ...
      <div class="d-c-c pb16" v-if="curItem.data.length < 5">
        <el-button plain type="primary" @click="onEditorAddData"
          >+添加{{ curItem.data.length }}/5</el-button
        >
      </div>
    </el-form>
  </div>
