<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" class="common-dialog" width="1100px" append-to-body>
      ...
      <div class="item-config" v-if="form.type != 'recharge'">
        <div class="rule-item-op">
          ...
          <el-button type="primary" size="small" icon="el-icon-plus" plain @click="addRuleItem">添加项目</el-button>
        </div>
        <el-table :data="form.detailList" border size="default" style="width: 100%">
          ...
          <el-table-column label="操作" width="77">
            <template #default="scope">
              <el-button size="small" @click="removeRule(scope.row.goodsId)" type="text">删除<i class="el-icon-delete"></i>
              </el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <!--商品服务选择列表-->
    <el-dialog title="商品选择" v-model="openSelect" class="common-dialog" width="700px" append-to-body>
      <el-table
        :data="selectGoodList"
        border
        size="default"
