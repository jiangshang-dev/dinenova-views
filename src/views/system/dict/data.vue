...
import { listType, getType as getTypeApi } from "@/api/system/dict/type";
...
const { loading, ids, single, multiple, showSearch, total, dataList, defaultDictType, title, open, listClassOptions, typeOptions, queryParams, form, rules } = toRefs(state)

function getType(dictId) {

      getTypeApi(dictId).then(response => {
